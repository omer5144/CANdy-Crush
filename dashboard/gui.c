...
gui_data_t setup_gui()
{
    ...
    gui_data.right_light_rect.x = SCREEN_WIDTH * 0.96 - gui_data.left_light_rect.w;
    gui_data.right_light_rect.y = SCREEN_HEIGHT * 0.1;
    ...
    gui_data.front_right_door_rect.y = SCREEN_HEIGHT * 0.73;
    gui_data.front_right_door_rect.w = right_door->w / 2;
    gui_data.front_right_door_rect.h = right_door->h / 2;
    gui_data.back_left_door_rect.x = SCREEN_WIDTH * 0.051;
    ...
    gui_data.back_right_door_rect.x = SCREEN_WIDTH * 0.132;
    gui_data.back_right_door_rect.y = SCREEN_HEIGHT * 0.8;
