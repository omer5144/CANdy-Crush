...
def switch_signals(interface: str) -> None:
    left_signal = can.Message(arbitration_id=SIGNAL_ID, is_extended_id=False, data=LEFT_SIGNAL_DATA)
    right_signal = can.Message(arbitration_id=SIGNAL_ID, is_extended_id=False, data=RIGHT_SIGNAL_DATA)
